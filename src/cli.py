...
def cli() -> None:
    ...
    parser.add_argument(
        "--model-name", type=str, metavar="S", help="model name or path"
    )
    parser.add_argument(
        "--tokenizer-name",
        type=str,
    ...
    parser.add_argument(
        "--save-model", action="store_true", default=False, help="save model"
    )
    parser.add_argument(
        "--hf-token",
        type=str,
        default=None,
        help="hugginface acces token for private models",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="path to JSON config file for model params",
    )
    parser.add_argument(
        "--save-results",
        type=lambda x: x.lower() == "true",
